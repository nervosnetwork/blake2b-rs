...
fn bindgen_test_layout_blake2b_param__() {
    assert_eq!(
        ::core::mem::size_of::<blake2b_param__>(),
        64usize,
        concat!("Size of: ", stringify!(blake2b_param__))
    );
    assert_eq!(
        ::core::mem::align_of::<blake2b_param__>(),
        1usize,
        concat!("Alignment of ", stringify!(blake2b_param__))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<blake2b_param__>())).digest_length as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<blake2b_param__>())).key_length as *const _ as usize },
        1usize,
        concat!(
            "Offset of field: ",
            stringify!(blake2b_param__),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<blake2b_param__>())).fanout as *const _ as usize },
        2usize,
        concat!(
            "Offset of field: ",
            stringify!(blake2b_param__),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<blake2b_param__>())).depth as *const _ as usize },
        3usize,
        concat!(
            "Offset of field: ",
            stringify!(blake2b_param__),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<blake2b_param__>())).node_depth as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(blake2b_param__),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<blake2b_param__>())).inner_length as *const _ as usize },
        17usize,
        concat!(
            "Offset of field: ",
            stringify!(blake2b_param__),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<blake2b_param__>())).reserved as *const _ as usize },
        18usize,
        concat!(
            "Offset of field: ",
            stringify!(blake2b_param__),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<blake2b_param__>())).salt as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(blake2b_param__),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<blake2b_param__>())).personal as *const _ as usize },
        48usize,
        concat!(
            "Offset of field: ",
            stringify!(blake2b_param__),
